# The name of this view in Looker is "Estimate Lines Fiat Chrysler Automobiles"
view: estimate_lines_fiat_chrysler_automobiles {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `EstimateLines.EstimateLines_FIAT_CHRYSLER_AUTOMOBILES`
    ;;
  drill_fields: [id]
