# The name of this view in Looker is "Estimate Lines General Motors"
view: estimate_lines_general_motors {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `EstimateLines.EstimateLines_General_Motors`
    ;;
  drill_fields: [id]
